...
#        (e dal quale verranno caricati) i fileAudio e i le loro associazioni
...
def bind(audio_name, id):
    # devo farlo perchè se non ci sono almeno due elementi nella lista di oggetti,
    # questa non è iterabile, quindi non posso effettuare il for audio in my_objects
...
def give_volume():
    ...
    # la funzione replace rimuove il punto decimale del volume convertito nell' intervallo 10-100
